...
const Product = () => {
    ...
    return productData ? (
        <>
            <Navbar />
            <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10 text-white bg-black-900">
                    ...
                    <div className="flex flex-col">
                            ...
                            <table className="table-auto border-collapse w-full max-w-72">
                                <tbody>
                                    <tr>
                                        ...
                                        <td className="text-gray-200">Generic</td>
                                    </tr>
                                    <tr>
                        ...
                        <div className="flex items-center mt-10 gap-4">
                            ...
                            <button
                                ...
                                className="w-full py-3.5 bg-gradient-to-r from-purple-500 to-fuchsia-500 -full text-white font-medium hover:opacity-90 transition"
                            >
                                Buy now
                            </button>
                        </div>
                ...
                <div className="flex flex-col items-center">
                    <div className="flex flex-col items-center mb-4 mt-16">
                        <p className="text-3xl font-medium">Featured <span className="font-medium text-purple-500">Products</span></p>
                        <div className="w-28 h-0.5 bg-purple-500 mt-2"></div>
                    </div>
